...
LAUNCHDROP_DIR = os.path.join(BASE_DIR, 'launchdrop')
PRODUCTS_DIR = os.path.join(LAUNCHDROP_DIR, 'products')
RENDERED_DIR = os.path.join(LAUNCHDROP_DIR, 'rendered')
ASSETS_DIR = os.path.join(LAUNCHDROP_DIR, 'assets')
...
def generate_landing_page(yaml_path):
    ...
    try:
        cmd = ['python', os.path.join(LAUNCHDROP_DIR, 'launchdrop.py'), yaml_path]
